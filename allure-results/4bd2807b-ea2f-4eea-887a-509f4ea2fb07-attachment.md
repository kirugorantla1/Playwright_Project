...
Locator: internal:role=getByText('Free')
Expected: "Free"
InvalidSelectorError: Error while parsing selector `getByText('Free')` - unexpected symbol "(" at position 9
...
Call log:
  ...
  - waiting for internal:role=getByText('Free')
    ...
    - generic [ref=e4]:
      ...
      - navigation [ref=e11]:
        - link "Home" [ref=e12] [cursor=pointer]:
          - /url: /
          - button "Home" [ref=e13]
        - link "10 Shopping Cart" [ref=e14] [cursor=pointer]:
          - /url: /cart
          - button "10 Shopping Cart" [ref=e15]:
            - img
            - generic [ref=e16]: "10"
